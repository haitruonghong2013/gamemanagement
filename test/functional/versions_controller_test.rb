...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { description: @version.description, name: @version.name, version: @version.version }
    end
  ...
  test "should update version" do
    put :update, id: @version, version: { description: @version.description, name: @version.name, version: @version.version }
    assert_redirected_to version_path(assigns(:version))
  end
