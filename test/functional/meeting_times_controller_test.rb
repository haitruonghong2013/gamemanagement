...
class MeetingTimesControllerTest < ActionController::TestCase
  ...
  test "should create meeting_time" do
    assert_difference('MeetingTime.count') do
      post :create, meeting_time: { actual_time: @meeting_time.actual_time, estimate_time: @meeting_time.estimate_time, meeting_id: @meeting_time.meeting_id, variance: @meeting_time.variance }
    end
  ...
  test "should update meeting_time" do
    put :update, id: @meeting_time, meeting_time: { actual_time: @meeting_time.actual_time, estimate_time: @meeting_time.estimate_time, meeting_id: @meeting_time.meeting_id, variance: @meeting_time.variance }
    assert_redirected_to meeting_time_path(assigns(:meeting_time))
  end
